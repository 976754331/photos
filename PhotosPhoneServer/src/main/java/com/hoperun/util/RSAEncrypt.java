...
public final class RSAEncrypt {
	...
	private static String DEFAULT_PRIVATE_KEY = "MIICeAIBADANBgkqhkiG9w0BAQEFAASCAmIwggJeAgEAAoGBAMABpLy5kYxiNpy0"
			...
			+ "lzQkQInYbfFiGlRZGRr1uUAey2TArN605Xv+M42O/P3jhd1DUG24acogMM4qrHrB" + "UIsvXAj5mRIh0r62";

	private static String DEFAULT_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDAAaS8uZGMYjactCWO6vgcpwUy"
			+ "MSAG7RBHOGLAmP1GKXwVZ86HYFD2JXLgiaUXNj4rMSGDQLpTqrSM0/QoBwZ2oEOU"
			+ "NaBF4wDyGZnRAk9w16kr9uvR0C++YOp2XquRzttWvakQszIgUhEYN/kTn5BfMSOx" + "qjTUgNTuIkQjE0ansQIDAQAB";
	...
	public static void main(String args[]) throws Exception {
		String pwd = ConfigTools.encrypt(RSAEncrypt.getDefaultPrivateKey(), "root");
		System.out.println(pwd);
		String s = ConfigTools.decrypt(RSAEncrypt.getDefaultPublicKey(), pwd);
