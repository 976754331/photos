...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "tjqx";
     ...
     * @param context
     * @param key The name of the preference to modify
     * @return True if the key were successfully remove .
     */
     ...
     * @param context
     * @param key The name of the preference to retrieve
     * @return  if constains the key return true ,otherwise return false;
     *         
     */
