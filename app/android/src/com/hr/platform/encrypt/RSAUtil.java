...
public class RSAUtil {
	...
	static {
		try {
			keyPair = GetKeFromFile.getKeyPair();
	 ...
	 * @throws Exception
	 */
	public static byte[] encryptByPublicKey(Key key, byte[] data) throws Exception {
		try {
	 ...
	 * @throws Exception
	 */
	public static byte[] decryptByPrivateKey(Key key, byte[] raw) throws Exception {
		try {
			Cipher cipher = Cipher.getInstance("RSA", new org.bouncycastle.jce.provider.BouncyCastleProvider());
	...
	public static void main(String[] args) throws Exception {
		...
		byte[] encodebyte = rsa.encryptByPublicKey(pubKey, str.getBytes());
		System.out.println("加密后==" + new String(encodebyte));
		String data = new String(encodebyte);
		System.out.println(
				"解密后==" + new String(rsa.decryptByPrivateKey(priKey, rsa.encryptByPublicKey(pubKey, str.getBytes()))));
	}
}
